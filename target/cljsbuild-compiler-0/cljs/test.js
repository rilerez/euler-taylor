...
var len__4736__auto___8243 = arguments.length;
var i__4737__auto___8244 = (0);
while(true){
if((i__4737__auto___8244 < len__4736__auto___8243)){
args__4742__auto__.push((arguments[i__4737__auto___8244]));

var G__8245 = (i__4737__auto___8244 + (1));
i__4737__auto___8244 = G__8245;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq8240){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8241,G__8242,seq8240__$2);
}));
...
var map__8247 = m;
var map__8247__$1 = (((((!((map__8247 == null))))?(((((map__8247.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8247.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8247):map__8247);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8247__$1,cljs.core.cst$kw$file);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8247__$1,cljs.core.cst$kw$line);
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8247__$1,cljs.core.cst$kw$column);
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8246_SHARP_){
return cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__8246_SHARP_));
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__8249 = cljs.core.get_global_hierarchy;
...
var formatter_fn = (function (){var or__4126__auto__ = cljs.core.cst$kw$formatter.cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env());
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__8250 = cljs.core.cst$kw$expected.cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__8250) : formatter_fn.call(null,G__8250));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__8251 = cljs.core.cst$kw$actual.cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__8251) : formatter_fn.call(null,G__8251));
})()], 0));
});
...
var temp__5720__auto___8252 = cljs.core.cst$kw$message.cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___8252)){
var message_8253 = temp__5720__auto___8252;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_8253], 0));
} else {
}
...
var temp__5720__auto___8254 = cljs.core.cst$kw$message.cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___8254)){
var message_8255 = temp__5720__auto___8254;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_8255], 0));
} else {
}
...
var output_dir__$1 = (function (){var G__8256 = output_dir;
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__8258 = exception.stack;
var G__8258__$1 = (((G__8258 == null))?null:clojure.string.split_lines(G__8258));
var G__8258__$2 = (((G__8258__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__8258__$1,depth));
if((G__8258__$2 == null)){
return null;
} else {
return clojure.string.trim(G__8258__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__8259 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8259,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8259,(1),null);
var vec__8262 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8262,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8262,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8262,(2),null);
...
var m__$1 = (function (){var G__8265 = cljs.core.cst$kw$type.cljs$core$IFn$_invoke$arity$1(m);
var G__8265__$1 = (((G__8265 instanceof cljs.core.Keyword))?G__8265.fqn:null);
switch (G__8265__$1) {
case "fail":
...
var G__8268 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6277__auto__,temp__5720__auto__){
return (function (){
var G__8269 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__8269) : cljs.test.run_block.call(null,G__8269));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__8268) : obj.call(null,G__8268));
} else {
var G__8271 = (function (){var G__8270 = cljs.core.rest(fns);
if(cljs.core.truth_(cljs.core.cst$kw$cljs$test_SLASH_block_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(obj)))){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__8270);
} else {
return G__8270;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__8272,cljs.core.assoc,cljs.core.cst$kw$cljs$test_SLASH_block_QMARK_,true);
}
});
...
return (function (g){
var G__8276 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__8276) : f1.call(null,G__8276));
});
});
/**
...
var vec__8277 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8277,(0),null);
var types = vec__8277;
...
var G__8281 = type;
var G__8282 = cljs.core.cst$kw$async;
var fexpr__8280 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$map,cljs.core.cst$kw$async,cljs.core.cst$kw$fn,cljs.core.cst$kw$sync,cljs.core.cst$kw$cljs$analyzer_SLASH_analyzed,true], null);
return (fexpr__8280.cljs$core$IFn$_invoke$arity$2 ? fexpr__8280.cljs$core$IFn$_invoke$arity$2(G__8281,G__8282) : fexpr__8280.call(null,G__8281,G__8282));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__8283){
var vec__8284 = p__8283;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8284,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8284,(1),null);
return (function (){
...
var G__8287 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var G__8289 = (function (){
var seq__8290 = cljs.core.seq(vars__$1);
var chunk__8291 = null;
var count__8292 = (0);
var i__8293 = (0);
while(true){
if((i__8293 < count__8292)){
var v = chunk__8291.cljs$core$IIndexed$_nth$arity$2(null,i__8293);
var temp__5720__auto___8299 = cljs.core.cst$kw$test.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5720__auto___8299)){
var t_8300 = temp__5720__auto___8299;
var G__8296_8301 = ((function (seq__8290,chunk__8291,count__8292,i__8293,t_8300,temp__5720__auto___8299,v,each_fixture_fn,G__8287,G__8287__$1,env,once_fixtures,each_fixtures,vec__8284,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_8300)));
});})(seq__8290,chunk__8291,count__8292,i__8293,t_8300,temp__5720__auto___8299,v,each_fixture_fn,G__8287,G__8287__$1,env,once_fixtures,each_fixtures,vec__8284,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__8296_8301) : each_fixture_fn.call(null,G__8296_8301));
} else {
}


var G__8302 = seq__8290;
var G__8303 = chunk__8291;
var G__8304 = count__8292;
var G__8305 = (i__8293 + (1));
seq__8290 = G__8302;
chunk__8291 = G__8303;
count__8292 = G__8304;
i__8293 = G__8305;
...
var temp__5720__auto__ = cljs.core.seq(seq__8290);
if(temp__5720__auto__){
var seq__8290__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__8290__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__8290__$1);
var G__8306 = cljs.core.chunk_rest(seq__8290__$1);
var G__8307 = c__4556__auto__;
var G__8308 = cljs.core.count(c__4556__auto__);
var G__8309 = (0);
seq__8290 = G__8306;
chunk__8291 = G__8307;
count__8292 = G__8308;
...
var v = cljs.core.first(seq__8290__$1);
var temp__5720__auto___8310__$1 = cljs.core.cst$kw$test.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5720__auto___8310__$1)){
var t_8311 = temp__5720__auto___8310__$1;
var G__8297_8312 = ((function (seq__8290,chunk__8291,count__8292,i__8293,t_8311,temp__5720__auto___8310__$1,v,seq__8290__$1,temp__5720__auto__,each_fixture_fn,G__8287,G__8287__$1,env,once_fixtures,each_fixtures,vec__8284,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_8311)));
});})(seq__8290,chunk__8291,count__8292,i__8293,t_8311,temp__5720__auto___8310__$1,v,seq__8290__$1,temp__5720__auto__,each_fixture_fn,G__8287,G__8287__$1,env,once_fixtures,each_fixtures,vec__8284,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__8297_8312) : each_fixture_fn.call(null,G__8297_8312));
} else {
}


var G__8313 = cljs.core.next(seq__8290__$1);
var G__8314 = null;
var G__8315 = (0);
var G__8316 = (0);
seq__8290 = G__8313;
...
var fexpr__8288 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__8288.cljs$core$IFn$_invoke$arity$1 ? fexpr__8288.cljs$core$IFn$_invoke$arity$1(G__8289) : fexpr__8288.call(null,G__8289));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8287__$1)].join('')));
...
var G__8317 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,cljs.core.cst$kw$end_DASH_test_DASH_vars,cljs.core.cst$kw$vars,vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__8317) : cljs.test.report.call(null,G__8317));
})], null)));
});
/**
