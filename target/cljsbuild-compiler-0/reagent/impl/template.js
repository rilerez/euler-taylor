...
var G__5950 = o;
goog.object.set(G__5950,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__5951__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__5951 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5952__i = 0, G__5952__a = new Array(arguments.length -  0);
while (G__5952__i < G__5952__a.length) {G__5952__a[G__5952__i] = arguments[G__5952__i + 0]; ++G__5952__i;}
  args = new cljs.core.IndexedSeq(G__5952__a,0,null);
} 
return G__5951__delegate.call(this,args);};
G__5951.cljs$lang$maxFixedArity = 0;
G__5951.cljs$lang$applyTo = (function (arglist__5953){
var args = cljs.core.seq(arglist__5953);
return G__5951__delegate(args);
});
...
var G__5954 = o;
goog.object.set(G__5954,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__5956__i < G__5956__a.length) {G__5956__a[G__5956__i] = arguments[G__5956__i + 0]; ++G__5956__i;}
  args = new cljs.core.IndexedSeq(G__5956__a,0,null);
} 
...
var G__5958 = props;
var G__5958__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5958,cljs.core.cst$kw$id,id):G__5958);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5958__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__5958__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__5959 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5959,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__5959;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5960){
var map__5961 = p__5960;
var map__5961__$1 = (((((!((map__5961 == null))))?(((((map__5961.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5961.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5961):map__5961);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5961__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__5963_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5963_SHARP_);
}));
} else {
return null;
}
...
var vec__5966 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5966,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5966,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5966,(2),null);
...
var temp__5724__auto___5970 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___5970 == null)){
} else {
var key_5971 = temp__5724__auto___5970;
(jsprops.key = key_5971);
}
...
var temp__5724__auto___5972 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___5972 == null)){
} else {
var key_5973 = temp__5724__auto___5972;
(jsprops.key = key_5973);
}
...
var G__5974 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5974) : reagent.impl.template.as_element.call(null,G__5974));
} else {
var temp__5724__auto___5975 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___5975 == null)){
} else {
var key_5976 = temp__5724__auto___5975;
(jsprops.key = key_5976);
}
...
var G__5978 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__5978)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__5978)){
return x;
} else {
...
var len__4736__auto___5981 = arguments.length;
var i__4737__auto___5982 = (0);
while(true){
if((i__4737__auto___5982 < len__4736__auto___5981)){
args__4742__auto__.push((arguments[i__4737__auto___5982]));

var G__5983 = (i__4737__auto___5982 + (1));
i__4737__auto___5982 = G__5983;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5979){
var G__5980 = cljs.core.first(seq5979);
var seq5979__$1 = cljs.core.next(seq5979);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5980,seq5979__$1);
}));
...
break;
default:
var G__5986 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5986;
continue;
...
var ctx = ({});
var vec__5988 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5988,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5988,(1),null);
...
var G__5991 = (cljs.core.count(argv) - first_child);
switch (G__5991) {
case (0):
...
break;
case (1):
var G__5992 = component;
var G__5993 = jsprops;
var G__5994 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__5992,G__5993,G__5994);
