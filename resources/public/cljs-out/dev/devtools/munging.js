...
var o25475 = temp__5718__auto__;
var temp__5718__auto____$1 = (o25475["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o25476 = temp__5718__auto____$1;
return (o25476["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24584__auto__ = f;
return (o__24584__auto__["toString"]).call(o__24584__auto__);
} else {
return "";
}
}catch (e25477){var _ = e25477;
return "";
}});
...
try{var o__24584__auto___25479 = t;
(o__24584__auto___25479["cljs$lang$ctorPrWriter"]).call(o__24584__auto___25479,t,writer);
}catch (e25478){var __25480 = e25478;
}
...
var char_code = (function (){var o__24584__auto__ = (new String(char$));
return (o__24584__auto__["charCodeAt"]).call(o__24584__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24584__auto__ = String;
return (o__24584__auto__["fromCharCode"]).call(o__24584__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25481 = num_code;
switch (G__25481) {
case (1):
return (185);
...
var o__24584__auto__ = String;
return (o__24584__auto__["fromCharCode"]).call(o__24584__auto__,superscript_code);
});
/**
...
}catch (e25483){var _e__24591__auto__ = e25483;
return false;
}})())){
...
var vec__25484 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25484,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o25487 = temp__5718__auto__;
var temp__5718__auto____$1 = (o25487["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o25488 = temp__5718__auto____$1;
return (o25488["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___25495 = arguments.length;
var i__4737__auto___25496 = (0);
while(true){
if((i__4737__auto___25496 < len__4736__auto___25495)){
args__4742__auto__.push((arguments[i__4737__auto___25496]));

var G__25497 = (i__4737__auto___25496 + (1));
i__4737__auto___25496 = G__25497;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25491){
var vec__25492 = p__25491;
var ns_detector = cljs.core.nth.call(null,vec__25492,(0),null);
...
var G__25498 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25499 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25498;
remaining_tokens = G__25499;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25489){
var G__25490 = cljs.core.first.call(null,seq25489);
var seq25489__$1 = cljs.core.next.call(null,seq25489);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25490,seq25489__$1);
}));
...
var vec__25503 = cljs.core.split_with.call(null,(function (p1__25502_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25502_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25503,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25503,(1),null);
...
var vec__25509 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25509,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25509,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25512 = cljs.core.rest.call(null,remaining_tokens);
var G__25513 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25512;
name_tokens = G__25513;
continue;
} else {
...
var vec__25516 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25516,(0),null);
var arity = cljs.core.nth.call(null,vec__25516,(1),null);
var vec__25519 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25519,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25519,(1),null);
var vec__25522 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25522,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25522,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25522,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25522,(3),null);
...
var vec__25528 = result;
var munged_ns = cljs.core.nth.call(null,vec__25528,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25528,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25528,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25528,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25528,(4),null);
var arity = cljs.core.nth.call(null,vec__25528,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__25532 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__25532,(0),null);
var args = cljs.core.nth.call(null,vec__25532,(1),null);
var vec__25535 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__25538 = (arity + (1));
var G__25539 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25540){
var vec__25541 = p__25540;
var arity = cljs.core.nth.call(null,vec__25541,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25541,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25544_SHARP_){
return cljs.core.get.call(null,arities,p1__25544_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25545_SHARP_){
return cljs.core.drop.call(null,(2),p1__25545_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___25552 = arguments.length;
var i__4737__auto___25553 = (0);
while(true){
if((i__4737__auto___25553 < len__4736__auto___25552)){
args__4742__auto__.push((arguments[i__4737__auto___25553]));

var G__25554 = (i__4737__auto___25553 + (1));
i__4737__auto___25553 = G__25554;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25548){
var vec__25549 = p__25548;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25549,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25546){
var G__25547 = cljs.core.first.call(null,seq25546);
var seq25546__$1 = cljs.core.next.call(null,seq25546);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25547,seq25546__$1);
}));
...
var G__25555 = arg;
var G__25555__$1 = (((G__25555 instanceof cljs.core.Keyword))?G__25555.fqn:null);
switch (G__25555__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25557__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25557__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25557__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25557__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25558 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25558,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25558,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25558,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25558,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25558,(4),null);
var arity = cljs.core.nth.call(null,vec__25558,(5),null);
...
var o__24584__auto__ = f;
return (o__24584__auto__["getBasis"]).call(o__24584__auto__);
});
/**
...
}catch (e25562){var _e__24591__auto__ = e25562;
...
var G__25563 = (obj[cljs.core.first.call(null,path)]);
var G__25564 = cljs.core.rest.call(null,path);
obj = G__25563;
path = G__25564;
continue;
} else {
...
var _STAR_ = (function (accum,p__25565){
var vec__25566 = p__25565;
var bit = cljs.core.nth.call(null,vec__25566,(0),null);
var protocol = cljs.core.nth.call(null,vec__25566,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25569){
var vec__25570 = p__25569;
var ns = cljs.core.nth.call(null,vec__25570,(0),null);
var name = cljs.core.nth.call(null,vec__25570,(1),null);
var selector = cljs.core.nth.call(null,vec__25570,(2),null);
...
var post_process = (function (p__25574){
var vec__25575 = p__25574;
var munged_name = cljs.core.nth.call(null,vec__25575,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25575,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25573_SHARP_){
return (obj[cljs.core.first.call(null,p1__25573_SHARP_)]);
}),sorted_matches);
