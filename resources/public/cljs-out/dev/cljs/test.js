...
var G__23617 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23617,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23617;
}
}));
...
var len__4736__auto___23622 = arguments.length;
var i__4737__auto___23623 = (0);
while(true){
if((i__4737__auto___23623 < len__4736__auto___23622)){
args__4742__auto__.push((arguments[i__4737__auto___23623]));

var G__23624 = (i__4737__auto___23623 + (1));
i__4737__auto___23623 = G__23624;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23619){
var G__23620 = cljs.core.first.call(null,seq23619);
var seq23619__$1 = cljs.core.next.call(null,seq23619);
var G__23621 = cljs.core.first.call(null,seq23619__$1);
var seq23619__$2 = cljs.core.next.call(null,seq23619__$1);
...
var map__23626 = m;
var map__23626__$1 = (((((!((map__23626 == null))))?(((((map__23626.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23626.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23626):map__23626);
var file = cljs.core.get.call(null,map__23626__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23626__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23626__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__23625_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23625_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__4619__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__4126__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var temp__5720__auto___23628 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___23628)){
var message_23629 = temp__5720__auto___23628;
cljs.core.println.call(null,message_23629);
} else {
}
...
var temp__5720__auto___23630 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___23630)){
var message_23631 = temp__5720__auto___23630;
cljs.core.println.call(null,message_23631);
} else {
}
...
var output_dir__$1 = (function (){var G__23632 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__23632,"/"].join('');
} else {
return G__23632;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__23634 = exception.stack;
var G__23634__$1 = (((G__23634 == null))?null:clojure.string.split_lines.call(null,G__23634));
var G__23634__$2 = (((G__23634__$1 == null))?null:cljs.core.get.call(null,G__23634__$1,depth));
if((G__23634__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23634__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__23635 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23635,(0),null);
var column = cljs.core.nth.call(null,vec__23635,(1),null);
var vec__23638 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23638,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23638,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23638,(2),null);
...
var m__$1 = (function (){var G__23641 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23645 = (function (){var G__23644 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23644);
} else {
return G__23644;
}
})();
...
return cljs.core.vary_meta.call(null,G__23646,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23650 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23650,(0),null);
var types = vec__23650;
...
return cljs.core.map.call(null,(function (p__23653){
var vec__23654 = p__23653;
var ns = cljs.core.nth.call(null,vec__23654,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__23654,(1),null);
return (function (){
...
var G__23657 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__23658 = cljs.core.seq.call(null,vars__$1);
var chunk__23659 = null;
var count__23660 = (0);
var i__23661 = (0);
while(true){
if((i__23661 < count__23660)){
var v = cljs.core._nth.call(null,chunk__23659,i__23661);
var temp__5720__auto___23663 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___23663)){
var t_23664 = temp__5720__auto___23663;
each_fixture_fn.call(null,((function (seq__23658,chunk__23659,count__23660,i__23661,t_23664,temp__5720__auto___23663,v,each_fixture_fn,G__23657,G__23657__$1,env,once_fixtures,each_fixtures,vec__23654,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23664)));
});})(seq__23658,chunk__23659,count__23660,i__23661,t_23664,temp__5720__auto___23663,v,each_fixture_fn,G__23657,G__23657__$1,env,once_fixtures,each_fixtures,vec__23654,ns,vars__$1))
);
} else {
}


var G__23665 = seq__23658;
var G__23666 = chunk__23659;
var G__23667 = count__23660;
var G__23668 = (i__23661 + (1));
seq__23658 = G__23665;
chunk__23659 = G__23666;
count__23660 = G__23667;
i__23661 = G__23668;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__23658);
if(temp__5720__auto__){
var seq__23658__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23658__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__23658__$1);
var G__23669 = cljs.core.chunk_rest.call(null,seq__23658__$1);
var G__23670 = c__4556__auto__;
var G__23671 = cljs.core.count.call(null,c__4556__auto__);
var G__23672 = (0);
seq__23658 = G__23669;
chunk__23659 = G__23670;
count__23660 = G__23671;
i__23661 = G__23672;
continue;
} else {
var v = cljs.core.first.call(null,seq__23658__$1);
var temp__5720__auto___23673__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___23673__$1)){
var t_23674 = temp__5720__auto___23673__$1;
each_fixture_fn.call(null,((function (seq__23658,chunk__23659,count__23660,i__23661,t_23674,temp__5720__auto___23673__$1,v,seq__23658__$1,temp__5720__auto__,each_fixture_fn,G__23657,G__23657__$1,env,once_fixtures,each_fixtures,vec__23654,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23674)));
});})(seq__23658,chunk__23659,count__23660,i__23661,t_23674,temp__5720__auto___23673__$1,v,seq__23658__$1,temp__5720__auto__,each_fixture_fn,G__23657,G__23657__$1,env,once_fixtures,each_fixtures,vec__23654,ns,vars__$1))
);
} else {
}


var G__23675 = cljs.core.next.call(null,seq__23658__$1);
var G__23676 = null;
var G__23677 = (0);
var G__23678 = (0);
seq__23658 = G__23675;
chunk__23659 = G__23676;
count__23660 = G__23677;
i__23661 = G__23678;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23657__$1)].join('')));
