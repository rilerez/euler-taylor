...
var G__25580 = devtools.prefs.pref.call(null,v);
v = G__25580;
continue;
} else {
return v;
...
}catch (e25583){var _e__24591__auto__ = e25583;
return false;
}})();
...
}catch (e25587){var _e__24591__auto__ = e25587;
return false;
}})();
...
}catch (e25589){var _e__24591__auto__ = e25589;
return false;
}}
}
});
...
var vec__25591 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25591,(0),null);
var name = cljs.core.nth.call(null,vec__25591,(1),null);
...
return cljs.core.some.call(null,(function (p1__25594_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25594_SHARP_);
}),template);
});
